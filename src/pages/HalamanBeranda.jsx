  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="bg-gradient-to-r from-orange-500 to-amber-400 rounded-2xl p-8 text-white text-center mb-10">
        <h1 className="text-4xl font-bold mb-3">🍽️ Selamat Datang di Dapur Holut Yudawan</h1>
      ...
      <div className="grid grid-cols-3 gap-4 mb-10">
        <div className="bg-white rounded-xl shadow p-5 text-center border border-orange-100">
          <p className="text-3xl font-bold text-orange-600">{daftarResep.length}</p>
        ...
        {daftarResep.slice(0, 4).map(resep => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-orange-500">{resep.kategori} · {resep.waktuMasak}</p>
            </div>
          </Link>
        ))}
      </div>
